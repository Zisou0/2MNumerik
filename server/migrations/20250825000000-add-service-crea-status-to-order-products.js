...
module.exports = {
  async up(queryInterface, Sequelize) {
    // Add new status values for service crea to order_products table
  ...
  async down(queryInterface, Sequelize) {
    ...
    await queryInterface.sequelize.query(`
      UPDATE order_products SET statut = 'en_cours' WHERE statut IN ('attente_validation', 'modification');
    `);
